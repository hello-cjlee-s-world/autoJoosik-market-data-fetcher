DROP TABLE tb_stock_info;
DROP TABLE tb_trade_info_log;
...
DROP INDEX IF EXISTS idx_tb_trade_info_log_created_at;
...
CREATE INDEX idx_tb_trade_info_log_tm ON tb_trade_info_log (tm);
CREATE INDEX idx_tb_trade_info_log_stextp ON tb_trade_info_log (stex_tp);
CREATE INDEX idx_tb_trade_info_log_created_at ON tb_trade_info_log (created_at);
ALTER TABLE tb_trade_info_log ADD CONSTRAINT tb_trade_info_log_unique UNIQUE (stk_cd, tm, cur_prc, cntr_trde_qty);
...
CREATE TABLE tb_schedule_info ( -- 스케줄 목록
